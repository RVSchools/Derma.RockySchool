...
class CatalogNavigationTabs(BrowserView):
    ...
    def topLevelTabs(self, actions=None, category='portal_tabs'):
        ...
        #short-circuit as proof of concept
        #result.append({'name':'Apple','id':'Students','url':'/students','description':'Apples are yummy'})
        #return result
        ...
        #this is likely where the proper hack will go...
        query['review_state'] = ['public','all_users']
