...
class IPortalToolBar(IViewletManager):
    """A new viewlet manager to wrap breadcrumbs and personal tools
       (Skin exposes a square of page-wrapper bgcolor between the two, which
       we are wrapping to set a bgcolor and hide it.)
    """
